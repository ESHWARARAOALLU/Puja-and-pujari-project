...
def checkout():
    ...
    email=session.get('selected_mail')
    address=session.get('selected_address')
    return render_template('checkout.html',n=n,selected_location=selected_location,num=num,address=address,email=email)
...
def testimonial():
    ...
    email=session.get('selected_mail')
    address=session.get('selected_address')
    return render_template('testimonial.html',selected_location=selected_location,num=num,address=address,email=email)
...
def profile():
    ...
    selected_location=session.get('selected_loc')
    mail=session.get('selected_mail')
    address=session.get('selected_address')
    
    return render_template('profile.html', name=name, email=email, phno=phno,address=address, l=l, l1=l1,id=id,address_list=address_list,saved_addresses=saved_addresses,pujaList=pujaList,pra1=pra1,selected_location=selected_location,mail=email)
